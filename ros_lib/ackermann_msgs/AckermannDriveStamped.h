...
namespace ackermann_msgs
{
  ...
  class AckermannDriveStamped : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "ackermann_msgs/AckermannDriveStamped"; };
    virtual const char * getMD5() override { return "1fd5d7f58889cefd44d29f6653240d0c"; };
