#ifndef _ROS_roadmap_msgs_RoadmapProperty_h
#define _ROS_roadmap_msgs_RoadmapProperty_h
...
namespace roadmap_msgs
{
  ...
  class RoadmapProperty : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "roadmap_msgs/RoadmapProperty"; };
