...
namespace vision_msgs
{
  ...
  class ObjectHypothesisWithPose : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "vision_msgs/ObjectHypothesisWithPose"; };
    virtual const char * getMD5() override { return "fa1ab3bc7146f53921fa142d631d02db"; };
