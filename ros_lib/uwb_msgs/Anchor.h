#ifndef _ROS_uwb_msgs_Anchor_h
#define _ROS_uwb_msgs_Anchor_h
...
namespace uwb_msgs
{
  ...
  class Anchor : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "uwb_msgs/Anchor"; };
    virtual const char * getMD5() override { return "079d232f6abe62102466c29f7a7c07c0"; };
