#ifndef _ROS_mobility_msgs_Semantics_h
#define _ROS_mobility_msgs_Semantics_h
...
namespace mobility_msgs
{
  ...
  class Semantics : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "mobility_msgs/Semantics"; };
    virtual const char * getMD5() override { return "6daa159ead38b97729c59783416a0963"; };
