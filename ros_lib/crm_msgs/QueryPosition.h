#ifndef _ROS_SERVICE_QueryPosition_h
#define _ROS_SERVICE_QueryPosition_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char QUERYPOSITION[] = "crm_msgs/QueryPosition";

  class QueryPositionRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return QUERYPOSITION; };
    virtual const char * getMD5() override { return "cc153912f1453b708d221682bc23d9ac"; };

  };

  class QueryPositionResponse : public ros::Msg
  {
    public:
  ...
  class QueryPosition {
    public:
    typedef QueryPositionRequest Request;
    typedef QueryPositionResponse Response;
  };
